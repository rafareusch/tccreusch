...
typedef struct writeSecurePort_TxRegs_dataS { 
    union { 
        Uns16 value;
    } txReq_RStoRNS;
    union { 
...
} writeSecurePort_TxRegs_dataT, *writeSecurePort_TxRegs_dataTP;
...
extern writeSecurePort_TxRegs_dataT writeSecurePort_TxRegs_data;
